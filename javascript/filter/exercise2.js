let users = [
    ...
    },
    {
        ...
        "contact": {
            "phone": "0456322879",
            "email": "poncinalex@hotmail.com"
        },
        "address": {
            "street": "Avenue de Julliet",
            "snumber": 11,
            "city": "brussel",
            "zipcode": 1000
        },
...
//     console.log(`Name : ${user.name.toUpperCase()}\nAdress : \n    City : ${user.address.city.toUpperCase()}\n    Street : ${user.address.street.toUpperCase()}\n    Zipcode : ${user.address.zipcode} \nContact :\n    Phone number : ${user.contact.phone.toUpperCase()}\n    Email :  ${user.contact.email.toUpperCase()}\nCourse : ${user.class.course.toUpperCase()}\n programs : ${user.class.programs.toString()}\n-----------------------`)
// });
...
//reduce() method
var numbers = [44, 52, 2, 65, 89, 7, 85, 54, 87, 23];
...
var nestedArray = [1, 2, 3, [4, 5, 6], [7, 8, 9], ["a", "b", "c"]];
//fill() method
